...
The service definitions are contained in a `services` object. Each key of the object is the name used to  
...
- `helper` _optional_ **string**: Name of the factory helper method that will already give us the service object
